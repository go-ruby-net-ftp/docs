...
The public API lives at the module root (`github.com/go-ruby-net-ftp/net-ftp`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `net-ftp`, while the surface follows
...
```go
import "github.com/go-ruby-net-ftp/net-ftp"
```
...
- **[pkg.go.dev/github.com/go-ruby-net-ftp/net-ftp](https://pkg.go.dev/github.com/go-ruby-net-ftp/net-ftp)**

The module's [README](https://github.com/go-ruby-net-ftp/net-ftp#readme) carries worked
