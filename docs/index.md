# go-ruby-net-ftp documentation

**Pure-Go, MRI-4.0.5-faithful Ruby net-ftp (no cgo)**

`go-ruby-net-ftp/net-ftp` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `net-ftp`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-net-ftp/net-ftp`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `net-ftp`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-net-ftp/net-ftp
```
...
| Repo | What it is |
| --- | --- |
| [`net-ftp`](https://github.com/go-ruby-net-ftp/net-ftp) | the library — Ruby's `net-ftp` in pure Go |
| [`docs`](https://github.com/go-ruby-net-ftp/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-net-ftp.github.io`](https://github.com/go-ruby-net-ftp/go-ruby-net-ftp.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-net-ftp/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-net-ftp/net-ftp](https://github.com/go-ruby-net-ftp/net-ftp).
