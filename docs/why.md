...
`go-ruby-net-ftp/net-ftp` reimplements Ruby's `net-ftp` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-net-ftp/net-ftp` directly, with no Ruby runtime;
